package com.unab.digitalresidency.shared;

import java.io.Serializable;

public class UsuarioDto implements Serializable { // Intermediario entre peticion y respuesta

    private static final long serialVersionUID=1L;

    private long id; // nuevo
    private String idUsuario; // nuevo
    ...
    private String passwordEncriptada; //nuevo
